...
@flask_app.route('/')
def healthcheck():
    return jsonify({"status": "healthy", "service": "AI Artist Bot", "version": "1.0.0"}), 200

@flask_app.route('/health')
def health():
    return jsonify({"status": "healthy", "service": "AI Artist Bot"}), 200
...
def run_bot():
    ...
    try:
        logger.info("Starting AI Artist Bot...")
...
if __name__ == "__main__":
    # Start Flask in a separate thread for healthchecks
    def start_flask():
        try:
